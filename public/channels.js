...
(function () {
  ...
  let autoScroll = true;
  let nodeCache = {};
  // #1498: WS-pushed messages stamped _fromWS; mergeWsAppendedIntoRest
  // preserves them across REST refreshes so they aren't stomped.
  var MAX_WS_SURVIVOR_MS = 5 * 60 * 1000;
